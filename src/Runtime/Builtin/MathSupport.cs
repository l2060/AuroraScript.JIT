...
namespace AuroraScript.Runtime.Builtin
{
    ...
    public sealed partial class MathSupport : ScriptObject
    {
        ...
        [Export("abs", MatchFailure.ReturnNaN)]
        ...
        [Export("ceil", MatchFailure.ReturnNaN)]
