...
```powershell
dotnet test tests\AuroraScript.Tests\AuroraScript.Tests.csproj -c Release --no-build --settings tests\AuroraScript.Tests\coverlet.runsettings --collect:"XPlat Code Coverage"
```
