...
- Console/JSON/HotPatch (Bonding): `src/Runtime/Extensions`
- Math/TDoc native host exports: `src/Runtime/Extensions`, generated by `language-tools/AuroraScript.Hosting.Generators/AuroraExportGenerator.cs`
- Host export attributes: `src/Hosting`
