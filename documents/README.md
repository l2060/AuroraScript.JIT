...
- `docs/host-integration.md`: .NET host API and advanced integration guide, including custom source resolver rules, `[NativeType]` / `AddNativeType` / `WithNativeTypes`, and `declare type` contracts.
